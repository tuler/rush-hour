...
void seqt_init(void)
{
    ...
    seqt_synth HIGHKICK_WAVE = {.waves = {{
                                              ...
                                              .sustain = 0.8f,
                                              .release = 0.1f,
                                              .start_frequency = RIV_NOTE_Eb3,
                                              .end_frequency = RIV_NOTE_C0,
                                              .amplitude = 0.4f,
                                              .sustain_level = 0.5f,
                                              .duty_cycle = 0.5f,
                                              .pan = 0.125f,
    ...
    seqt_synth HIT_WAVE = {.waves = {{
                               ...
                               .sustain = 0.05f,
                               .release = 0.05f,
                               .start_frequency = RIV_NOTE_C7,
                               .end_frequency = RIV_NOTE_C7,
                               .amplitude = 0.08f,
                               .sustain_level = 0.1f,
                               .duty_cycle = 0.5f,
                               .pan = 0.0f,
    ...
    seqt_synth CRASH_WAVE = {.waves = {{
                                 ...
                                 .sustain = 0.0f,
                                 .release = 0.9f,
                                 .start_frequency = RIV_NOTE_Eb6,
                                 .end_frequency = 2 * RIV_NOTE_Eb8,
                                 .amplitude = 0.12f,
                                 .sustain_level = 0.4f,
                                 .duty_cycle = 0.5f,
                                 .pan = 0.0f,
    ...
    seqt_synth HIGHCLICK_WAVE = {.waves = {{
                                     ...
                                     .sustain = 0.2f,
                                     .release = 0.3f,
                                     .start_frequency = RIV_NOTE_Eb7,
                                     .end_frequency = RIV_NOTE_Eb7,
                                     .amplitude = 0.06f,
                                     .sustain_level = 0.3f,
                                     .duty_cycle = 0.5f,
                                     .pan = 0.0f,
